...
export const AuthProvider = ({ children }) => {
  ...
  const checkUserLoggedIn = async (force = false) => {
    ...
    if (token) {
      try {
        ...
        const response = await fetch('https://ohanatienda.ddns.net/api/user', {
          headers: {
  ...
  const login = async (email, password) => {
    try {
      const response = await fetch('https://ohanatienda.ddns.net/api/login', {
        method: 'POST',
        headers: {
  ...
  const logout = async () => {
    ...
    if (currentToken) {
      try {
        await fetch('https://ohanatienda.ddns.net/api/logout', {
          method: 'POST',
          headers: {
